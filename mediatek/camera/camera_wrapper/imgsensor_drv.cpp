...
)
{
...
#else
    m_SenosrResInfo[0].SensorPreviewWidth = 2096;
    m_SenosrResInfo[0].SensorPreviewHeight = 1552;
    m_SenosrResInfo[0].SensorFullWidth = 4192;
    m_SenosrResInfo[0].SensorFullHeight = 3104;
    m_SenosrResInfo[0].SensorVideoWidth = 4192;
    m_SenosrResInfo[0].SensorVideoHeight = 3104;
    m_SenosrResInfo[0].SensorHighSpeedVideoWidth = 640;
    m_SenosrResInfo[0].SensorHighSpeedVideoHeight = 480;
    m_SenosrResInfo[0].SensorSlimVideoWidth = 1280;
    m_SenosrResInfo[0].SensorSlimVideoHeight = 720;
    m_SenosrResInfo[0].SensorCustom1Width = 2088;
    m_SenosrResInfo[0].SensorCustom1Height = 1544;
    m_SenosrResInfo[0].SensorCustom2Width = 2088;
    m_SenosrResInfo[0].SensorCustom2Height = 1544;
    m_SenosrResInfo[0].SensorCustom3Width = 2088;
    m_SenosrResInfo[0].SensorCustom3Height = 1544;
    m_SenosrResInfo[0].SensorCustom4Width = 2088;
    m_SenosrResInfo[0].SensorCustom4Height = 1544;
    m_SenosrResInfo[0].SensorCustom5Width = 2088;
    m_SenosrResInfo[0].SensorCustom5Height = 1544;

    m_SenosrResInfo[1].SensorPreviewWidth = 1280;
    m_SenosrResInfo[1].SensorPreviewHeight = 960;
    m_SenosrResInfo[1].SensorFullWidth = 2560;
    m_SenosrResInfo[1].SensorFullHeight = 1920;
    m_SenosrResInfo[1].SensorVideoWidth = 1280;
    m_SenosrResInfo[1].SensorVideoHeight = 960;
    ...
    m_SenosrResInfo[1].SensorSlimVideoHeight = 960;
#endif
    return err;
