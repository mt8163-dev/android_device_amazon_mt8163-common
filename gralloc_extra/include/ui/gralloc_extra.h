...
enum {
    ...
    /* PQ bit 6, 7 */
    GRALLOC_EXTRA_BIT2_PQ_OFF       = GRALLOC_EXTRA_MAKE_BIT(6,0),
    GRALLOC_EXTRA_BIT2_PQ_ON        = GRALLOC_EXTRA_MAKE_BIT(6,1),
    GRALLOC_EXTRA_BIT2_PQ_DEBUG     = GRALLOC_EXTRA_MAKE_BIT(6,2),    
    GRALLOC_EXTRA_MASK2_PQ          = GRALLOC_EXTRA_MAKE_MASK(6,7),
	/* PQ bit 8 */
    GRALLOC_EXTRA_BIT2_PQ_SCRN_SHOT_ON		= GRALLOC_EXTRA_MAKE_BIT(8,0),
    GRALLOC_EXTRA_BIT2_PQ_SCRN_SHOT_OFF		= GRALLOC_EXTRA_MAKE_BIT(8,1),
    GRALLOC_EXTRA_MASK2_PQ_SCRN_SHOT		= GRALLOC_EXTRA_MAKE_MASK(8,8),
};
