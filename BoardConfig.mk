...
COMMON_GLOBAL_CFLAGS += -DNO_SECURE_DISCARD -DDISABLE_HW_ID_MATCH_CHECK
...
# Shim Libraries
TARGET_LDPRELOAD += libshim_log.so:libshim_ui.so:libshim_parcel.so:libshim_camera.so:libshim_drm.so:libshim_audio.so
