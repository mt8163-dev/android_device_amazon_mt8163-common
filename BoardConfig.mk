...
# Filesystem
#BOARD_BOOTIMAGE_PARTITION_SIZE := 16777216 Using prebuilt boot doesn't need this..
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 20971520 We are not using cm recovery..
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1692925952 
BOARD_USERDATAIMAGE_PARTITION_SIZE := 13282312192
BOARD_CACHEIMAGE_PARTITION_SIZE := 434176
