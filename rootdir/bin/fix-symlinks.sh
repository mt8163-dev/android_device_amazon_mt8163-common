...
REAL_PL_HDR0=`readlink -f /dev/block/platform/mtk-msdc.0/by-name/boot0hdr0`
REAL_PL_HDR1=`readlink -f /dev/block/platform/mtk-msdc.0/by-name/boot0hdr1`
REAL_PL_IMG0=`readlink -f /dev/block/platform/mtk-msdc.0/by-name/boot0img0`
REAL_PL_IMG1=`readlink -f /dev/block/platform/mtk-msdc.0/by-name/boot0img1`
...
rm /dev/block/platform/mtk-msdc.0/by-name/boot0hdr0
rm /dev/block/platform/mtk-msdc.0/by-name/boot0hdr1
rm /dev/block/platform/mtk-msdc.0/by-name/boot0img0
rm /dev/block/platform/mtk-msdc.0/by-name/boot0img1
...
ln -s $REAL_PL_HDR0 /dev/block/platform/mtk-msdc.0/by-name/boot0hdr0_real
ln -s $REAL_PL_HDR1 /dev/block/platform/mtk-msdc.0/by-name/boot0hdr1_real
ln -s $REAL_PL_IMG0 /dev/block/platform/mtk-msdc.0/by-name/boot0img0_real
ln -s $REAL_PL_IMG1 /dev/block/platform/mtk-msdc.0/by-name/boot0img1_real
...
ln -s /dev/null /dev/block/platform/mtk-msdc.0/by-name/boot0hdr0
ln -s /dev/null /dev/block/platform/mtk-msdc.0/by-name/boot0hdr1
ln -s /dev/null /dev/block/platform/mtk-msdc.0/by-name/boot0img0
ln -s /dev/null /dev/block/platform/mtk-msdc.0/by-name/boot0img1
